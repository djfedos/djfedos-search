...
"""
The benchmarking functions are below this line. 
"""
...
def test_benchmark_get_suggestions_prefix(tmpdir, num_lines=200, prefix_length=100, limit=100, cycles=1000, result_path='get_suggestions_benchmark_prefix.csv'):
    tfk = TokensFileCreator(tmpdir)
